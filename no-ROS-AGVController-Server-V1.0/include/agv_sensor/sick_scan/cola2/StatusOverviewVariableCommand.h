...
#ifndef SICK_SAFETYSCANNERS_COLA2_STATUSOVERVIEWVARIABLECOMMAND_H
#define SICK_SAFETYSCANNERS_COLA2_STATUSOVERVIEWVARIABLECOMMAND_H


#include <cola2/VariableCommand.h>
#include <data_processing/ParseStatusOverview.h>
 ...
 */
class StatusOverviewVariableCommand : public VariableCommand
{
public:
  /*!
   ...
   * \param status_overview Reference to the status overview variable, which will be written on
   * execution.
   */
  StatusOverviewVariableCommand(Cola2Session& session,
...
#endif // SICK_SAFETYSCANNERS_COLA2_STATUSOVERVIEWVARIABLECOMMAND_H
