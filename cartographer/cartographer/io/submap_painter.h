...
namespace io {
  //clark
using PixId = std::pair<int16 /* x cells */, int16 /* y cells */>;
using PixSurfById = std::vector<std::pair<PixId, ::cartographer::io::UniqueCairoSurfacePtr>>;
