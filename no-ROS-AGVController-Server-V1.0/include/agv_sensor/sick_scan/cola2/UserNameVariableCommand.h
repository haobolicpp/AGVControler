...
#ifndef SICK_SAFETYSCANNERS_COLA2_USERNAMEVARIABLECOMMAND_H
#define SICK_SAFETYSCANNERS_COLA2_USERNAMEVARIABLECOMMAND_H
 ...
 */
class UserNameVariableCommand : public VariableCommand
{
public:
  /*!
   ...
   * \param user_name Reference to the user name variable, which will be written on
   * execution.
   */
...
#endif // SICK_SAFETYSCANNERS_COLA2_USERNAMEVARIABLECOMMAND_H
