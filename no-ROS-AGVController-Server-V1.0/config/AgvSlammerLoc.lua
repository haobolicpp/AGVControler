...
TRAJECTORY_BUILDER_2D.max_range = 32.
...
-- TRAJECTORY_BUILDER_2D.ceres_scan_matcher.degeneration_condition = 150.
...
-- POSE_GRAPH.ceres_scan_matcher.degeneration_condition = 250.
