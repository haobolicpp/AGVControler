...
#ifndef SICK_SAFETYSCANNERS_COLA2_SERIALNUMBERVARIABLECOMMAND_H
#define SICK_SAFETYSCANNERS_COLA2_SERIALNUMBERVARIABLECOMMAND_H

#include <string>

#include <cola2/VariableCommand.h>
#include <data_processing/ParseSerialNumber.h>
#include <datastructure/CommSettings.h>
#include <datastructure/SerialNumber.h>

namespace sick {
namespace cola2 {

class SerialNumberVariableCommand : public VariableCommand
{
public:
  /*!
   ...
   * \param serial_number The variable to which the serial number will be written on execution.
   */
  SerialNumberVariableCommand(Cola2Session& session, datastructure::SerialNumber& serial_number);
...
#endif // SICK_SAFETYSCANNERS_COLA2_SERIALNUMBERVARIABLECOMMAND_H
