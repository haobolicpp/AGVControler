...
#ifndef SICK_SAFETYSCANNERS_COLA2_REQUIREDUSERACTIONVARIABLECOMMAND_H
#define SICK_SAFETYSCANNERS_COLA2_REQUIREDUSERACTIONVARIABLECOMMAND_H
 ...
 */
class RequiredUserActionVariableCommand : public VariableCommand
{
public:
  /*!
   ...
   * \param required_user_action Reference to the required user action variable, which will be
   * written on execution.
   */
  RequiredUserActionVariableCommand(Cola2Session& session,
...
#endif // SICK_SAFETYSCANNERS_COLA2_REQUIREDUSERACTIONVARIABLECOMMAND_H
