...
class Node {
 ...
 private:
  ...
  bool HandleStopPubMap(cartographer_ros_msgs::StopPubMap::Request& request,
    cartographer_ros_msgs::StopPubMap::Response& response);
...
Node::Node(const double resolution, const double publish_period_sec)
    ...
    pure_localization_(true),
      ...
      "StopPubMap", &Node::HandleStopPubMap, this);
                                       }

bool Node::HandleStopPubMap(cartographer_ros_msgs::StopPubMap::Request& request,
            cartographer_ros_msgs::StopPubMap::Response& response){
              LOG(INFO)<<"pure_localization_:"<<pure_localization_;
...
void Node::HandleSubmapList(
  ...
  for (const auto& submap_msg : msg->submap) {
    ...
    submap_slice.surface = ::cartographer::io::DrawTexture(
        ...
        //clark
        /*
    submap_slice.pixel_surfaces = ::cartographer::io::DrawPixelTexture(
    fetched_texture->pixels.intensity, fetched_texture->pixels.alpha,
...
void Node::DrawAndPublish(const ::ros::WallTimerEvent& unused_timer_event) {
  ...
  { 
    //clark
        ...
        //auto painted_slices = PaintSubmapSlicesByPixel(submap_slices_, resolution_);
